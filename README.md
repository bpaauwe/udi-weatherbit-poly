...
#### Short Poll
   * Not used
#### Long Poll
   * How often to poll the WeatherBit weather service. Note that the free plan only updates data hourly. Setting this to less may result in exceeding the free service rate limit.
